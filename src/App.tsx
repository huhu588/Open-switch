...
const McpPage = lazy(() =>
  import('./pages/McpPage').then((module) => ({ default: module.McpPage })),
);
...
const DevEnvPage = lazy(() =>
  import('./pages/DevEnvPage').then((module) => ({ default: module.DevEnvPage })),
);
const OhMyPage = lazy(() =>
  import('./pages/OhMyPage').then((module) => ({ default: module.OhMyPage })),
);
