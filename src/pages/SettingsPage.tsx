        ...
        {activeTab === 'about' && (
          <div className="about-container">
            ...
            <div className="credits-list">
              ...
              <button className="credit-item" onClick={() => openLink('https://github.com/jlcodes99/ai-switch')}>
                <div className="credit-icon" style={{ color: '#0f172a' }}><Github size={24} /></div>
                <h3>{t('settings.about.github')}</h3>
                <p>ai-switch</p>
              </button>

              <button className="credit-item" onClick={() => openLink('https://github.com/jlcodes99/ai-switch/blob/main/docs/DONATE.md')}>
              ...
              <button className="credit-item" onClick={() => openLink('https://github.com/jlcodes99/ai-switch/issues')}>
