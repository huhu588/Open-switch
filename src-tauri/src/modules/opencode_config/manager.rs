...
use crate::modules::opencode_config::mcp_manager::McpConfigManager;
use crate::modules::opencode_config::models::{GlobalConfig, OpenCodeActiveConfig, OpenCodeActiveReference};
use crate::modules::opencode_config::opencode_manager::OpenCodeConfigManager;
use crate::modules::opencode_config::ConfigError;
use std::fs;
...
impl ConfigManager {
    ...
    fn validate_providers_exist(
        ...
        opencode_config: &crate::modules::opencode_config::models::OpenCodeConfig,
    ) -> Result<(), ConfigError> {
