...
fn callback_success_html() -> &'static str {
    r#"<!doctype html><html><head><meta charset="utf-8"><title>Trae Login</title></head><body><h2>Trae 登录回调已完成</h2><p>可以返回 ai switch。</p></body></html>"#
}
...
async fn request_login_guidance(login_trace_id: &str) -> Result<String, String> {
    ...
    for endpoint in TRAE_LOGIN_GUIDANCE_URLS {
        ...
        let request = client
            ...
            .header("User-Agent", "Trae/1.0.0 ai-switch")
            .json(&body);
