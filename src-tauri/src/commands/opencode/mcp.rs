...
use crate::modules::opencode_config::{ConfigManager, McpServer, McpServerType, McpOAuthConfig};
...
pub fn sync_mcp_to_apps(
    ...
    use crate::modules::opencode_config::claude_code_manager::{ClaudeCodeConfigManager, ClaudeMcpServer};
    use crate::modules::opencode_config::codex_manager::{CodexConfigManager, CodexMcpServer};
    use crate::modules::opencode_config::gemini_manager::{GeminiConfigManager, GeminiMcpServer};
    use crate::modules::opencode_config::cursor_manager::{CursorConfigManager, CursorMcpServer};
...
pub fn get_apps_mcp_status(
    ...
    use crate::modules::opencode_config::cursor_manager::CursorConfigManager;
...
pub fn get_managed_mcps(
    ...
    // 检查 Windsurf
    if let Ok(windsurf_manager) = crate::modules::opencode_config::windsurf_manager::WindsurfConfigManager::new() {
    ...
    // 检查 Kiro
    if let Ok(kiro_manager) = crate::modules::opencode_config::kiro_manager::KiroConfigManager::new() {
    ...
    // 检查 Antigravity
    if let Ok(ag_manager) = crate::modules::opencode_config::antigravity_manager::AntigravityConfigManager::new() {
...
pub fn toggle_mcp_app(
    ...
    match app.as_str() {
        ...
        "windsurf" => {
            let windsurf_manager = crate::modules::opencode_config::windsurf_manager::WindsurfConfigManager::new()
                .map_err(|e| AppError::Custom(e))?;
            
            if enabled {
                if let Some(server) = source_server {
                    use crate::modules::opencode_config::windsurf_manager::WindsurfMcpServer;
        ...
        "kiro" => {
            let kiro_manager = crate::modules::opencode_config::kiro_manager::KiroConfigManager::new()
                .map_err(|e| AppError::Custom(e))?;
            
            if enabled {
                if let Some(server) = source_server {
                    use crate::modules::opencode_config::kiro_manager::KiroMcpServer;
        ...
        "antigravity" => {
            let ag_manager = crate::modules::opencode_config::antigravity_manager::AntigravityConfigManager::new()
                .map_err(|e| AppError::Custom(e))?;
            
            if enabled {
                if let Some(server) = source_server {
                    use crate::modules::opencode_config::antigravity_manager::AntigravityMcpServer;
